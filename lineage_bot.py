...
(
    ...
    STATE_DISOWN_TARGET,
    STATE_DISOWN_REASON,
    STATE_ADD_SIBLING_TARGET,
    STATE_ADD_SIBLING_TYPE,
    ...
    STATE_KICK_MEMBER_TARGET,
    STATE_KICK_MEMBER_REASON,
    STATE_WILL_INPUT,
    STATE_APPOINT_HEIR_TARGET,
    STATE_ADMIN_EDIT_TARGET,
    STATE_ADMIN_AUDIT_TARGET,
    STATE_ADMIN_SET_KOIN_TARGET,
    STATE_ADMIN_SET_KOIN_AMOUNT,
    STATE_ADMIN_RENAME_FAM_ID,
    STATE_ADMIN_RENAME_FAM_NAME,
    STATE_ADMIN_LOCK_FAM_ID,
    STATE_ADMIN_LOCK_FAM_REASON,
    STATE_ADMIN_UNLOCK_FAM_ID,
    STATE_ADMIN_FORCE_DIVORCE_TARGET,
    STATE_ADMIN_EXCOMMUNICATE_TARGET,
    STATE_ADMIN_EXCOMMUNICATE_REASON,
